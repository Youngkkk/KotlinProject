...
import com.young.kotlinproject.mvp.presenter.SearchPresenter
...
import com.young.kotlinproject.ui.adapter.HotKeywordsAdapter
import com.young.kotlinproject.utils.CleanLeakUtils
import com.young.kotlinproject.utils.StatusBarUtil
import com.young.kotlinproject.view.ViewAnimUtils
import kotlinx.android.synthetic.main.activity_search.*
import com.young.kotlinproject.R
import com.young.kotlinproject.view.ClearEditText
...
class SearchActivity : BaseActivity(), SearchContract.View {
    ...
    override fun initView() {
        ...
        //键盘的搜索按钮
        (et_search_view as ClearEditText).setOnEditorActionListener(object : TextView.OnEditorActionListener {
            override fun onEditorAction(v: TextView?, actionId: Int, event: KeyEvent?): Boolean {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    closeSoftKeyboard()
                    keyWords = (et_search_view as ClearEditText).text.toString().trim()
    ...
    override fun closeSoftKeyboard() {
        closeKeyBord(et_search_view as EditText, applicationContext)
    }
